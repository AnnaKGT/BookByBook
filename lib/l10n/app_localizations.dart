...
abstract class AppLocalizations {
  ...
  /// No description provided for @how_do_you_like_the_book.
  ///
  /// In en, this message translates to:
  /// **'How do you like the book?'**
  String get how_do_you_like_the_book;

  /// No description provided for @please_wait_momemt.
  ///
  /// In en, this message translates to:
  /// **'Please wait a momemt'**
  String get please_wait_momemt;
  ...
  /// No description provided for @login_view_email_and_password_cannot_be_empty.
  ///
  /// In en, this message translates to:
...
class _AppLocalizationsDelegate
  ...
  bool isSupported(Locale locale) =>
      <String>['en', 'sv', 'uk'].contains(locale.languageCode);
